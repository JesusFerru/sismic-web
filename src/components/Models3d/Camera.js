  ...
  useFrame(() => {
    if (
      ...
      if (camera.current) {
        ...
        if (
          Math.abs(cameraPosition[0] - dataContext.cameraPosition[0]) >
            positionChangeThreshold ||
          Math.abs(cameraPosition[1] - dataContext.cameraPosition[1]) >
            positionChangeThreshold ||
          Math.abs(cameraPosition[2] - dataContext.cameraPosition[2]) >
            positionChangeThreshold
        ) {
